...
import io.github.xiapxx.uid.generator.impl.utils.DateUtils;
import io.github.xiapxx.uid.generator.impl.utils.StringUtils;
...
public class DefaultUidGenerator implements UidGenerator {
    ...
    public String parseUID(long uid) {
        ...
        String thatTimeStr = DateUtils.formatDateTime(thatTime);
    ...
    public void setEpochStr(String epochStr) {
        if (StringUtils.isNotEmpty(epochStr)) {
            ...
            this.epochSeconds = TimeUnit.MILLISECONDS.toSeconds(DateUtils.parseDay(epochStr).getTime());
        }
    }
}
